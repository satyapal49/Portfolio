    ...
    return (
        ...
        className="py-20 bg-dark-100">
            <div className="container mx-auto px-6">
                ...
                <p className="text-grey-400 text-center max-w-2xl mx-auto mb-16">Technologies I work with to bring ideas to life</p>
                    ...
                    skills.map((skills, index)=>(
                        <div key={index} className="bg-dark-300 rounded-2xl p-6 hover:-translate-y-2 transition duration-300 cursor-pointer">
                            <div className="flex items-center mb-4">
                                <skills.icon className="w-12 h-12 text-orange mr-6"/>
                                <h3 className="text-xl font-semibold">{skills.title}</h3>
                            </div>
                            <p className="text-grey-400 mb-4">{skills.description}</p>
