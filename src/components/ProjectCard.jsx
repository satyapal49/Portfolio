        ...
        <div className="bg-dark-300 rounded-2xl overflow-hidden hover:-translate-y-2 transition duration-300 cursor-pointer">
            ...
            <div className="p-6">
                ...
                <div className="flex gap-2">
                    <a href={demo} className="flex-1 text-center px-4 py-2 bg-orange rounded-lg font-medium hover:bg-orange-700 transition duration-300">
                        View Demo
                    </a>
                    <a href={code} className="flex-1 text-center px-4 py-2 border border-orange font-medium rounded-lg gover:bg-orange/20 transition duration-300">Get Code</a>
                </div>
            </div>
        </div>
    )
