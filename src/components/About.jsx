...
const About = () => {
    return (
        ...
        viewport={{once: true}}
        id="about"
        className="pt-20 bg-dark-200">
            <div className="conatiner mx-0 px-6">
                {/* Heading */}
                <h2 className="text-3xl font-bold text-center mb-4">About
                    <span className="text-orange">Me</span>
                </h2>
                <p className="text-grey-400 text-center max-w-2xl mx-auto mb-16">Get to know more about my background and passion.</p>
                {/* Image + my Journey */}
                    ...
                    className="md:w-1/2">
                        <div className="rounded-2xl p-8">
                            ...
                            <p className="text-grey-300 mb-6">
                               I'm a passionate full-stack developer with over 1 years of experience creating digital solutions for businesses around the world. My journey started with basic HTML/CSS websites and has evolved into building complex web applications with modern frameworks. 
                            </p>
